...
export default function PressureSensorDrill() {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-grow">
        <iframe
          key={iframeKey}
          src={`http://localhost:3000/d-solo/76a7e6c9-d7c5-4f28-ad45-caccb7d2499c/dashbord-dt?orgId=1&timezone=utc&var-sensor_id=dps_light1&var-controller_ref=DPS001&var-Filters=${filters.selectedFilter}&from=${range.from}&to=${range.to}&theme=light&refresh=auto&panelId=19&__feature.dashboardSceneSolo=true`}
          className="w-full h-full border-0"
          title="Grafana Panel 19"
        />
      </div>
    </div>
  );
